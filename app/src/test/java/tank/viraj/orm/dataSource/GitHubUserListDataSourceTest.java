...
public class GitHubUserListDataSourceTest {
    ...
    /* get getGitHubUsersList list from ORM */
    @Test
    public void getGitHubUsersFromDaoTest() throws SQLException {
        ...
        Assert.assertEquals(1, testSubscriber.getOnNextEvents().get(0).get(0).getGitHubUserId());
        ...
        Assert.assertEquals(2, testSubscriber.getOnNextEvents().get(0).get(1).getGitHubUserId());
    ...
    /* get getGitHubUsersList list from Retrofit2 and update on ORM */
    @Test
